    ...
    <div class="row">
     ...
     <div class="col-md-6">
        <div class="panel panel-default">
                <div class="panel-heading">Case Registration</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Victim name</label>
                        ...
                        <div class="form-group{{ $errors->has('casecode') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Case code</label>

                            <div class="col-md-6">
                                <input type="text" pattern="[0-9]*" class="form-control" name="password">
                        ...
                        <div class="form-group{{ $errors->has('Case_details') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Case details</label>

                            <div class="col-md-6">
                                <textarea rows="4" cols="30">write</textarea> 

                                @if ($errors->has('Case_details'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('Case_details') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
